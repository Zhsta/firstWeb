...
<div class="container">
    ...
    <div class="row" >
        ...
        <div class="row col-lg-offset-4" id="add">
            <form class="form-horizontal" id="addForm"  role="form" action="/ManagerAddStudent" method="post">
        ...
        <div class="row col-lg-offset-4" id="delete">
            <form class="form-horizontal" id="deleteForm"  role="form" action="/ManagerDeleteStudent" method="post">
                <div class="form-group ">
                    <div class="col-md-6">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p></p>
                    <textarea class="form-control">学生账户不存在</textarea>
                </div>
    ...
    <div class="modal fade" id="exist" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p></p>
                    <textarea class="form-control">学生账户已经存在</textarea>
                </div>
                <div class="modal-footer">
                    <button data-dismiss="modal" class="btn btn-default" type="button">关闭</button>
                </div>
